...
!(async () => {
  ...
  // app.use(passport.initialize()); // do not work, see https://github.com/rkusa/koa-passport/issues/100#issuecomment-358718370
  ...
  let server = http.createServer(app.callback()).listen(8082, () => {
    // eslint-disable-line
